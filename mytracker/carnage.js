...
function displayPayload(response) {
  ...
  keys.forEach(function(key) {
    ...
    var allTime = allTimeCall(platform, memid).done(function(response) {
      ...
      var headerStyle = "background-image: linear-gradient(120deg, var(--color-win) 0%, gray 50%)";
      var bgStyle = "background-image: linear-gradient(120deg, var(--color-win) 0%, gray 50%)";
